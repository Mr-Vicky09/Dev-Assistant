...
export const skills = [
  ...
  { name: "Power BI", level: 85, icon: "chart" },
  { name: "R", level: 80, icon: "code" },
  { name: "Machine Learning", level: 75, icon: "brain" },
  { name: "Data Visualization", level: 92, icon: "eye" },
  { name: "Statistical Analysis", level: 88, icon: "stats" },
];
...
export const projects = [
  {
    ...
    description: "Real-time analytics dashboard with ML-powered predictions and interactive visualizations.",
  ...
  },
  {
    ...
    description: "Automated ETL system processing 10M+ records daily with 99.9% uptime.",
    tech: ["Apache Spark", "Airflow", "AWS", "PostgreSQL"],
    image: "/projects/pipeline-engine.jpg",
    link: "#",
    github: "#",
  },
  {
    ...
    description: "NLP-based tool analyzing social media sentiment for brand monitoring.",
    tech: ["Python", "BERT", "FastAPI", "MongoDB"],
  ...
  },
  {
    id: 4,
    title: "Viz Studio",
    description: "Custom visualization library for creating stunning data stories.",
    tech: ["TypeScript", "Canvas API", "WebGL", "SVG"],
    image: "/projects/viz-studio.jpg",
    link: "#",
    github: "#",
  },
];
